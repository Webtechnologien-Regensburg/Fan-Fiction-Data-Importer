...
class Story {
  ...
  constructor(category, rating, relationship, archiveWarnings, title, text, tags) {
  ...
  static fromJSON(json) {
    ...
    return new Story(jsonObject.category[0], jsonObject.rating, jsonObject.relationship[0], jsonObject.archive_warning, jsonObject.title, jsonObject.text, jsonObject.additional_tag[0]);
  }
